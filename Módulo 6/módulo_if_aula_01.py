...
meta = 50000
quantidadeVendida = 65.300

if quantidadeVendida >= meta:
    print(f'Batemos a meta de vendas de Iphone, vendemos {quantidadeVendida} unidades')
...
if quantidadeVendida >= meta:
    ...
    print(f'Infelizmente não batemos a meta, vendemos {quantidadeVendida} unidades. A meta era de {meta} unidades')
